...
add wave -noupdate -expand -group tb -color Gold /tb/SCK_LP
add wave -noupdate -expand -group tb -color Gold /tb/SCK_LN
add wave -noupdate -expand -group tb -color Gold /tb/SCK_HP
add wave -noupdate -expand -group tb -color Gold /tb/SCK_HN
...
add wave -noupdate -expand -group clk_divider /tb/dut/clk_divider/clk_100
add wave -noupdate -expand -group clk_divider /tb/dut/clk_divider/s_rst
add wave -noupdate -expand -group clk_divider /tb/dut/clk_divider/a_rst
add wave -noupdate -expand -group clk_divider /tb/dut/clk_divider/sck_out
add wave -noupdate -expand -group clk_divider /tb/dut/clk_divider/clk_cnt
...
add wave -noupdate -expand -group transmitter -radix binary /tb/dut/transmitter/shift_reg
...
WaveRestoreCursors {{Cursor 1} {3447359 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1801498 ps}
